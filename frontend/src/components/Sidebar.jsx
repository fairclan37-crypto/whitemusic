...
import { Home as HomeIcon, Search, Film, Library, Music2, LogOut, LogIn } from 'lucide-react';
        ...
        {menuItems.map(({ to, label, icon: Icon }, idx) => {
          ...
          return (
            ...
            >
              ...
              <Icon size={18} color={isActive ? 'var(--accent)' : 'currentColor'} style={{ flexShrink: 0 }} />
        ...
        {user ? (
          ...
          <div style={{
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <p style={{
                fontSize: 10.5, color: '#7a90b0', margin: '2px 0 0',
                whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
              }}>
                {user.email}
              </p>
            ...
            <button
              ...
              title="Sign Out"
              style={{
                background: 'none', border: 'none', color: '#7a90b0',
                cursor: 'pointer', padding: 4, flexShrink: 0,
                transition: 'color 0.15s, transform 0.15s',
              }}
              onMouseEnter={e => { e.currentTarget.style.color = '#ff4d4d'; e.currentTarget.style.transform = 'scale(1.1)'; }}
              onMouseLeave={e => { e.currentTarget.style.color = '#7a90b0'; e.currentTarget.style.transform = 'scale(1)'; }}
            >
              <LogOut size={16} />
            </button>
          </div>
          ...
          <button
            ...
            style={{
              ...
              background: 'linear-gradient(135deg, rgba(0,212,255,0.12), rgba(0,85,204,0.15))',
              border: '1px solid rgba(0,212,255,0.2)',
              color: '#fff', fontWeight: 700, fontSize: 12.5,
              display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
              cursor: 'pointer', transition: 'background 0.15s, transform 0.15s',
            }}
            onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.02)'; e.currentTarget.style.background = 'linear-gradient(135deg, rgba(0,212,255,0.2), rgba(0,85,204,0.25))'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.background = 'linear-gradient(135deg, rgba(0,212,255,0.12), rgba(0,85,204,0.15))'; }}
          >
            {/* Google SVG */}
